...
/*
10. Write a function stringToNumber that takes a string input and tries to convert it to a number. 
...
/*
11. Write a function flipBoolean that takes any input and converts it to its 
...
/*
12. Write a function whatAmI that takes an input and returns a string describing 
...
/*
13. Write a function isItTruthy that takes an input and returns "It's truthy!"
...
/*
14. Perform the following mathematical operations
...
console.log(devide(6, 7).toFixed(2)); //toFixed(2) method rounded to two decimal place.
...
console.log(remainder(11, 7).toFixed(2));
*/
